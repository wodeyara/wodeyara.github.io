A short demonstration of the **state-space phase estimator** — a method for estimating the phase of a neural rhythm *in real time*, together with a credible interval that tells you how certain that estimate is.
